...
{
    var $table = 'fr_testimonial';
    var $data_order = array();
    var $data_search = array();
    var $column_order = array(null,null,'foto','nama','note','status'); 
    var $column_search = array('foto','nama','note','status');
    ...
    {
        $this->db->select('id,foto,nama,note,status');
        $this->db->from('fr_testimonial');
