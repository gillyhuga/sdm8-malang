...
{
    var $table = 'fr_kata_sambutan';
    var $data_order = array();
    var $data_search = array();
    var $column_order = array(null,null,'foto','nama_kepala','note','status'); 
    var $column_search = array('foto','nama_kepala','note','status');
    ...
    {
        $this->db->select('id,foto,nama_kepala,note,status');
        $this->db->from('fr_kata_sambutan');
