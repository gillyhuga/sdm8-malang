...
class  Budaya_Model extends MY_Model
{
    var $table = 'fr_budaya_sekolah';
    var $data_order = array();
    var $data_search = array();
    var $column_order = array(null,null,'kategori','deskripsi','note','status'); 
    var $column_search = array('kategori','deskripsi','note','status');
    ...
    {
        $this->db->select('id,kategori,deskripsi,note,status');
        $this->db->from('fr_budaya_sekolah');
