...
<div class="row justify-content-md-center">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <h4 class="card-header btn-primary"><i class="icon md-edit"></i> Edit Slider</h4>
		<div class="card">
			<div class="card-body">
                ...
                <input type="hidden" id="id" name="id" value="<?= $slider->id ?>">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="hidden" name="prev_slider" id="prev_slider" value="<?= $slider->slider ?>" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" id="title" name="title" rows="4" placeholder="Title"><?= $slider->title ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="subtitle" class="col-md-4 col-form-label">Subtitle</label>
                        <div class="col-md-8">
                            <textarea class="form-control" id="subtitle" name="subtitle" rows="4" placeholder="Subtitle"><?= $slider->subtitle ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="order_menu" class="col-md-4 col-form-label">Order Menu</label>
                        <div class="col-md-8">
                            <input class="form-control" type="number" id="order_menu" name="order_menu" value="<?= $slider->order_menu ?>" placeholder="Order Menu">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="note" class="col-md-4 col-form-label">Note</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="note" name="note" value="<?= $slider->note; ?>" placeholder="Note">
                        </div>
                    </div>
...
<script> 
    ...
    function showPreview_slider(objFileInput) {
        if (objFileInput.files[0]) {
            ...
            $('#target_slider').hide();
            $('#no_slider').show();
            $("#no_slider").html('<img src="' + APP_URL + 'assets/backend/uploads/thumbnail/no_image.png" width="120px" height="120px"  style="border: 4px solid #eff2f7;margin: 7px;  border-radius: 4px;"/>');
        }
    }    
