...
<body class="defult-home">
                                    ...
                                    <nav class="rs-menu">
                                        <ul class="nav-menu">
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="sub-menu">
                                                    <li class="it-menu"><a href="home/sambutan">Sambutan kepala</a></li>
                                                    <li class="it-menu"><a href="home/profil">Profil sekolah</a></li>
                                                    <li class="it-menu">
                                                        <a href="home/budaya_sekolah">Budaya sekolah</a>
                                                    </li>
                                                    <li class="it-menu"><a href="home/visi_misi">Visi dan Misi</a></li>
                                                    <li class="it-menu">
                                                        <a href="home/guru">Guru dan Tenaga Pendidik</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="menu-item-has-children">
                                                <a href="#">Kesiswaan</a>
                                                <ul class="sub-menu">
                                                    <li class="it-menu"><a href="#">Program Ekstrakurikuler</a></li>
                                            ...
                                            <li class="menu-item-has-children"><a href="#">Informasi</a>
                                                <ul class="sub-menu">
                                                    <li class="it-menu"><a href="home/agenda">Agenda </a></li>
                                                    <li class="it-menu"><a href="home/berita">Berita</a></li>
                                                    <li class="it-menu"><a href="home/galleri">Galleri</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                        <!-- //.nav-menu -->
    ...
    <!-- Main content Start -->
    <input type="hidden" id="no_ajax" name="no_ajax" value="<?= $this->session->userdata('no_ajax'); ?>">
    <input type="hidden" id="no_ajax_url" name="no_ajax_url" value="<?= $this->session->userdata('no_ajax_url'); ?>">
    ...
    <script src="<?= __JS; ?>lombok/Spa2.js"></script>
    <script src="<?= __JS; ?>lombok/fr_custom.js"></script>
