                          ...
                          <div class="event-item">
                              <div class="event-short">
                                  <div class="featured-img">
                                      ...
                                      <div class="dates">
                                          <?= ___datetime($obj->tanggal_mulai); ?>
                                      </div>
                                  </div>
                                  <div class="content-part">
                                      <h4 class="title"><a href="#"><?= $obj->title; ?></a></h4>
                                      <div class="time-sec">
                                          <div class="timesec"><i class="fa fa-clock-o"></i><?= ___datetime($obj->tanggal_mulai); ?></div>
                                          <div class="timesec"><i class="fa fa-clock-o"></i><?= ___datetime($obj->tanggal_selesai); ?></div>
