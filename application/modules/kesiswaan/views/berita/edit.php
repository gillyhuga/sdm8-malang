...
<div class="row justify-content-md-center">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <h4 class="card-header btn-primary"><i class="icon md-edit"></i> Edit Berita</h4>
		<div class="card">
			<div class="card-body">
                ...
                <input type="hidden" id="id" name="id" value="<?= $berita->id ?>">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="hidden" name="prev_thumbnail" id="prev_thumbnail" value="<?= $berita->thumbnail ?>" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="title" name="title" value="<?= $berita->title; ?>" placeholder="Title">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <select class="form-control select2" id="kategori" name="kategori" style="width: 100%;">
                                ...
                                <?php foreach ($kategori as $key => $obj) { ?>
                                    <option value="<?= $obj->id; ?>" <?php if($obj->id == $berita->kategori){ echo 'selected="selected"';} ?>><?= $obj->nama; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" id="content" name="content" placeholder="content"><?= $berita->content; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="note" class="col-md-4 col-form-label">Note</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="note" name="note" value="<?= $berita->note; ?>" placeholder="Note">
                        </div>
                    </div>
...
<script> 
    ...
    function showPreview_thumbnail(objFileInput) {
        if (objFileInput.files[0]) {
            ...
            $('#no_thumbnail').show();
            $("#no_thumbnail").html('<img src="' + APP_URL + 'assets/backend/uploads/thumbnail/no_image.png" width="120px" height="120px"  style="border: 4px solid #eff2f7;margin: 7px;  border-radius: 4px;"/>');
        }
    } 
