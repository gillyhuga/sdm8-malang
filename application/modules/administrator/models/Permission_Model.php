...
class  Permission_Model extends MY_Model
{
    ...
    var $column_order = array(null,null,'name','slug','is_default','is_superadmin'); 
    var $column_search = array('name','slug','is_default','is_superadmin');
    ...
    {
        $this->db->select('id,name,slug,is_default,is_superadmin');
        $this->db->from('roles');
