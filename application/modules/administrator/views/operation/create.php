...
<div class="row justify-content-md-center">
    <div class="col-12 col-md-6 col-lg-6 col-xl-4">
        <h4 class="card-header btn-primary"> <i class="icon md-plus"></i> Add Operation</h4>
		<div class="card">
			<div class="card-body">
				<form class="form_validation" id="post-data" data-url="administrator/operation/store">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="operation_name" name="operation_name" placeholder="Operation Name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="operation_slug" class="col-md-4 col-form-label">Operation Slug</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="operation_slug" name="operation_slug" placeholder="Operation Slug">
                        </div>
                    </div>
                    <div class="form-group row">
