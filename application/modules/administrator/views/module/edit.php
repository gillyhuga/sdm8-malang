...
<div class="row justify-content-md-center">
    <div class="col-12 col-md-6 col-lg-6 col-xl-4">
        <h4 class="card-header btn-primary"><i class="icon md-edit"></i> Edit Module</h4>
		<div class="card">
			<div class="card-body">
                ...
                <input type="hidden" id="id" name="id" value="<?= $module->id ?>">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="module_name" name="module_name" value="<?= $module->module_name; ?>" placeholder="Module Name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="module_slug" class="col-md-4 col-form-label">Module Slug</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="module_slug" name="module_slug" value="<?= $module->module_slug; ?>" placeholder="Module Slug">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="module_icon" class="col-md-4 col-form-label">Module Icon</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="module_icon" name="module_icon" value="<?= $module->module_icon; ?>" placeholder="Module Icon">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="module_order" class="col-md-4 col-form-label">Module Order</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" id="module_order" name="module_order" value="<?= $module->module_order; ?>" placeholder="Module Order">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="note" class="col-md-4 col-form-label">Note</label>
                        <div class="col-md-8">
                            <textarea class="form-control" id="note" name="note" rows="4" placeholder="Note"><?= $module->note ?></textarea>
                        </div>
                    </div>
