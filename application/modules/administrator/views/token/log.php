<div class="page-button-data" id="lombok" data-url="administrator/token/">
    <?php if (is_admin()) { ?>
        <button id="btn_back" data-url="administrator/token/index" type="button" class="mb-2 btn btn-icon btn-primary waves-effect waves-classic">
    ...
    <div class="page-title" style="float: right;">LOGS TOKEN</div>
</div>
        ...
        <table class="table table-hover dataTable table-striped w-full " data-plugin="dataTable" id="log">
            <thead>
                <tr>
                    ...
                    <th><strong>Old Token</strong></th>
                    <th><strong>New Token</strong></th>
                    <th><strong>Token reset at</strong></th>
                    <th><strong>Token reset by</strong></th>
                </tr>
            </thead>
            <tbody>
