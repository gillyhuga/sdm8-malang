<div class="page-button-data" id="lombok" data-url="administrator/password/">
    <?php if (is_admin()) { ?>
        <button id="btn_back" data-url="administrator/password/index" type="button" class="mb-2 btn btn-icon btn-primary waves-effect waves-classic">
    ...
    <div class="page-title" style="float: right;">LOGS PASSWORD</div>
</div>
        ...
        <table class="table table-hover dataTable table-striped w-full " data-plugin="dataTable" id="log">
            <thead>
                <tr>
                    ...
                    <th><strong>Password reset at</strong></th>
                    <th><strong>Password reset by</strong></th>
                </tr>
            </thead>
            <tbody>
