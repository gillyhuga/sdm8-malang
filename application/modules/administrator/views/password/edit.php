...
<div class="row justify-content-md-center">
    <div class="col-12 col-md-6 col-lg-6 col-xl-4">
        <h4 class="card-header btn-primary"> <i class="icon md-edit"></i> Edit Password</h4>
		<div class="card">
			<div class="card-body">
				<form class="form_validation" id="post-data" data-url="administrator/password/store">
					<?= csrf(); ?>
                    ...
                    <hr>
                    <div class="form-group row">
                        <label for="auth" class="col-md-4 col-form-label">Your Password</label>
                        <div class="col-md-8">
