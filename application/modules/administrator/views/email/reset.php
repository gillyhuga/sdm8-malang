...
<div class="row justify-content-md-center">
    <div class="col-12 col-md-6 col-lg-6 col-xl-4">
		...
		<div class="card">
			<div class="card-body">
				<form class="form_validation" id="post-data" data-url="administrator/email/store">
					<?= csrf(); ?>
                    ...
                    <button type="button" id="btn_back" data-url="administrator/email" class="btn btn-icon btn-default waves-effect waves-classict">Close</button>
				</form>
			</div>
		</div>
	</div>
                ...
                email : {
                    validators: {
                        ...
                        remote: {
                            ...
                            url: '<?=site_url('administrator/email/check_email')?>',
                            type: 'POST',
                            delay: 250,
                            data: function() {
                                return {
