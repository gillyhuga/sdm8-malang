<div class="page-button-data" id="lombok" data-url="administrator/user/">
    <?php if (is_admin()) { ?>
        <button id="btn_back" data-url="administrator/user/index" type="button" class="mb-2 btn btn-icon btn-primary waves-effect waves-classic">
    ...
    <div class="page-title" style="float: right;">LOGS USER</div>
</div>
        ...
        <table class="table table-hover dataTable table-striped w-full " data-plugin="dataTable" id="log">
            <thead>
                <tr>
                    ...
                    <th><strong>Login at</strong></th>
                    <th><strong>Logout at</strong></th>
                </tr>
            </thead>
            <tbody>
                <?php $no=1; foreach ($log as $key => $obj) { ?>
                    <tr>
                        <td><?= $no++; ?></td>
                        <td><?= __datetime($obj->login_at);?></td>
                        <td><?= __datetime($obj->logout_at);?></td>
                    </tr>
                <?php } ?>
            </tbody>
            <tfoot>
