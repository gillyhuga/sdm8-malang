...
<script>
    ...
    $('#___fullname').autocomplete({
        source: 'admin/user/get_filter_by_fullname',
        autoFocus:true,
        minLength: 1,
    ...
    $('#___username').autocomplete({
        source: 'admin/user/get_filter_by_username',
        autoFocus:true,
        minLength: 1,
        select: function(event, ui){
    ...
    $.ajax({
        url: "<?= base_url('admin/user/edit_filter_by_role_id') ?>",
        dataType: 'JSON',
        type : 'POST',
        data: {
            _role_id : _role_id
    ...
    $("#___role_id").select2({
        ajax: {
            url: "<?= base_url('admin/user/get_filter_by_role_id') ?>",
            dataType: 'JSON',
            type: "GET",
            delay: 250,
    ...
    $('#___email').autocomplete({
        source: 'admin/user/get_filter_by_email',
        autoFocus:true,
        minLength: 1,
        select: function(event, ui){
