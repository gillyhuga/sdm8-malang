...
class  Kategori_berita_Model extends MY_Model
{
    var $table = 'fr_kategori_berita';
    var $data_order = array();
    var $data_search = array();
    var $column_order = array(null,null,'kategori','nama','note','status'); 
    var $column_search = array('kategori','nama','note','status');
    ...
    {
        $this->db->select('id,kategori,nama,note,status');
